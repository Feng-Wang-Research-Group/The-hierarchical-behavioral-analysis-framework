...
output_dir = r'F:\spontaneous_behavior\GitHub\The-hierarchical-behavioral-analysis-framework\Figure5_spatial_perference\SG_index_in_difference_regions'
...
time_window1 = 10
time_window2 = 60
location = 'perimeter'         #center, perimeter, corner

output_dir = output_dir + '_{}-{}min_{}'.format(time_window1,time_window2,location)
if not os.path.exists(output_dir):                                    
    os.mkdir(output_dir)    
...
plt.savefig(r'{}\sniffing&groming_movementfraction_index.png'.format(output_dir),transparent=False,dpi=300,bbox_inches='tight')
...
plt.savefig(r'{}\sniffing&groming_movementfrequency_index.png'.format(output_dir),transparent=False,dpi=300,bbox_inches='tight')
