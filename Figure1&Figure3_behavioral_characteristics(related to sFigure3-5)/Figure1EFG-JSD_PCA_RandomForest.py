...
output_dir = r'F:\spontaneous_behavior\GitHub\The-hierarchical-behavioral-analysis-framework\Figure1&Figure3_behavioral_characteristics(related to sFigure3-5)\group_dissimilarities'
...
#colors = ['#F5B25E', '#F5B25E', '#E75C6B','#E75C6B']
