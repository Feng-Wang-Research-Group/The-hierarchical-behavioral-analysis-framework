...
BehaviorAtlasData_dir =  r'F:\spontaneous_behavior\GitHub\The-hierarchical-behavioral-analysis-framework\01_BehaviorAtlas_collated_data'
revised_movement_dir = r'F:\spontaneous_behavior\GitHub\The-hierarchical-behavioral-analysis-framework\02_revised_movement_label'
output_dir = r'F:\spontaneous_behavior\GitHub\The-hierarchical-behavioral-analysis-framework\sFigure1_BehaviorAtlas_analysis_Framework(Feature Space)'
...
plt.savefig(r'{}\3D_movement_feature_space.png'.format(output_dir),dpi=1200,transparent =True)
