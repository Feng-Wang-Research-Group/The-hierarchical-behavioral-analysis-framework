...
output_dir = r'F:\spontaneous_behavior\GitHub\The-hierarchical-behavioral-analysis-framework\Figure1&Figure3_behavioral_characteristics(related to sFigure3-6)\movement_statistic'
...
'''
Relationship and biological significance of sniffing and grooming
'''
...
X = df_index[['SG_fra_index','SG_fre_index','GS_fra_index','GS_fre_index']]
y = df_index['group_id']
...
for train_index, test_index in skf.split(X, y):
    ...
    importances_df = pd.DataFrame(data=importances_feature,columns=['importances'],index=['SG_fra_index','SG_fre_index','GS_fra_index','GS_fre_index'])
