...
output_dir = r'F:\spontaneous_behavior\GitHub\The-hierarchical-behavioral-analysis-framework\Figure1&Figure3_behavioral_characteristics(related to sFigure3-6)\group_dissimilarities\singleFactor'
...
'''
## please select one of parameter for training
## example: speed, position, index, movement_fraction
'''
using_factor = 'speed'    
